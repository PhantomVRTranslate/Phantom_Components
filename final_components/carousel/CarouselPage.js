...
class Gallery extends React.Component {
    ...
    goToNext() {
        ...
        this.setState({imageNumber: nextImageNum});
    ...
    goToPrev() {
        ...
        this.setState({imageNumber: prevImageNum});
        this.rotateGallery(nextRotation);
    }
        ...
        return (
            ...
            <View>
                <View
                    ...
                    {this
                        ...
                        .map((image, idx) => {
                            ...
                            return (<GalleryItem imageStyle={imageStyle} src={image} isSelected={isSelected}/>);
                        })}
                </View>
                ...
                <VrButton
                    ...
                    disabled={false}
                    onClick={this.state.cardType === 'IMAGE'
                    ? this.prevCard
                    : this.prevSlice}>
                    <Text
                        style={{
